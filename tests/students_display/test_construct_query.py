...
def test_construct_where_clause(class_name: str, surname: str, predicted_where_clause: str):
...
def test_construct_query_for_fetching_students_by_surname(sorting_element: str, sorting_order: str,
                                                          where_clause: str, predicted_query: str):
    constructed_query = construct_query_for_fetching_students(sorting_element, sorting_order, where_clause)
