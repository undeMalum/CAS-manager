...
With_classWith_surname = "WHERE class_name = (:class_name) AND surname = (:surname)"
Without_classWith_surname = "WHERE surname = (:surname)"
...
@pytest.mark.parametrize("sorting_element, sorting_order, dict_key, predicted_query", [
    ("surname", "A-Z", "without_class-without_surname",
